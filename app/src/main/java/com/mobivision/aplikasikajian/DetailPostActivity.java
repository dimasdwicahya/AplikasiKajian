package com.mobivision.aplikasikajian;
...
import com.mobivision.aplikasikajian.adapter.CommentAdapter;
import com.mobivision.aplikasikajian.model.Comment;
import com.mobivision.aplikasikajian.model.User;
    ...
    public void addComment(View view) {
        databaseUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                User user = dataSnapshot.child(current_user.getUid()).getValue(User.class);
